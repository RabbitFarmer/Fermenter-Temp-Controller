...
def test_config_loading():
    ...
    try:
        ...
        if 'Black' in tilt_cfg:
            ...
            assert tilt_cfg['Black']['og_confirmed'], "Black tilt og_confirmed should be True"
        ...
        if 'Red' in tilt_cfg:
            ...
            assert not tilt_cfg['Red']['og_confirmed'], "Red tilt og_confirmed should be False"
...
def test_update_live_tilt():
    ...
    try:
        ...
        assert live_tilts['Black']['og_confirmed'], "og_confirmed should be True"
